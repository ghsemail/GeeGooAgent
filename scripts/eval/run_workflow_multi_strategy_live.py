#!/usr/bin/env python3
"""Live smoke: workflow_multi_strategy_compare (chat workflow serial probe).
...
CASE_ID = "workflow_multi_strategy_compare"
MESSAGE = "帮我在腾讯上对比 Macd4H 和 共振的信号买卖点"
PASS_KEYWORDS = ["多策略", "对比", "买", "卖"]
MIN_REPLY_CHARS = 80
CHAT_TIMEOUT = int(os.environ.get("WORKFLOW_EVAL_CHAT_TIMEOUT", "900"))
VERIFY_TIMEOUT = 120
...
def main() -> int:
    ...
    print("reply_preview:", reply[:400].replace("\n", " "))
