...
func AllHTTP() []HTTPSpec {
	raw := []HTTPSpec{
		...
		{Name: "get_single_prompt_template", Description: "获取分析 Prompt 模板列表。get_mcp_analysis 前必调；个股 type=tech，指数 index，基本面 fundamental。", Path: "/getSinglePromptTemplate", DirectResponse: true},
