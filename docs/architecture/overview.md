...
`internal/tools/registry.go` 中央注册表，**82** 个工具（catalog HTTP 转发 + bespoke 手写）。完整树形图：[layers/L2-tools/tools-tree.md](./layers/L2-tools/tools-tree.md)。关键能力：
...
| 层 | 数量 | 文档 |
|----|------|------|
| 已注册 Tool | **82** | [layers/L2-tools/tools-tree.md](./layers/L2-tools/tools-tree.md) |
...
7. [layers/L2-tools/tools-tree.md](./layers/L2-tools/tools-tree.md) — 哪些 Tool 能用
